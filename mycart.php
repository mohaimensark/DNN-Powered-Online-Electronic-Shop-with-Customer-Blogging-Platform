            ...
            <table class="table table-bordered table-striped text-center">
              <thead>
                ...
                <tr>
                  ...
                  <th>Total Price</th>
                  <th>
                    <a href="action.php?clear=<?= $user_id ?>" class="badge-danger badge p-1" onclick="return confirm('Are you sure want to clear your cart?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                  </th>
                </tr>
              </thead>
              <tbody>
