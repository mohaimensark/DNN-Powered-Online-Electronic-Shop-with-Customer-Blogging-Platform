...
// OpenAI APIの設定
$apiKey = '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'; // OpenAI APIキーに置き換えてください
...
function chatGPT($messages) {
    ...
    $data = [
        'model' => 'text-davinci-001', // 使用するモデルを指定
        'messages' => $messages,
        ...
        <div class="container">
            ...
            <div class="field is-grouped">
                <p class="control is-expanded">
                    <input id="user-input" class="input" type="text" placeholder="Ask question">
                </p>
                <p class="control">
